...
static const struct TrainerMon sParty_Ed_Reginald[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_SMART_STRIKE, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_SLOT_1,
    },
};
...
static const struct TrainerMon sParty_Ed_Adam1[] = {
    ...
    .moves = {MOVE_TAILWIND, MOVE_MOONBLAST, MOVE_ENERGY_BALL, MOVE_TOXIC},
    .nature = NATURE_TIMID,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUG_BITE, MOVE_AERIAL_ACE, MOVE_NEEDLE_ARM, MOVE_NONE},
    .nature = NATURE_DOCILE,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HEADBUTT, MOVE_ROCK_SMASH, MOVE_ROCK_SLIDE, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_SCALD, MOVE_AQUA_RING, MOVE_ICE_BEAM, MOVE_NONE},
    .nature = NATURE_BOLD,
    .ability = ABILITY_SLOT_1,
    },
};
...
static const struct TrainerMon sParty_Ed_Adam2[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_TAILWIND, MOVE_HYDRO_PUMP, MOVE_AIR_SLASH, MOVE_TOXIC},
    .nature = NATURE_TIMID,
    .ability = ABILITY_SLOT_2,
    },
    {
    ...
    .moves = {MOVE_HYPER_VOICE, MOVE_SHADOW_BALL, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_BOLD,
    .ability = ABILITY_HIDDEN,
    },
};
