...
static const struct TrainerMon sParty_Ed_Elise[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLAM, MOVE_RAZOR_LEAF, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_ADAMANT,
    .ability = ABILITY_SLOT_1,
    },
};
...
static const struct TrainerMon sParty_Ed_Amy[] = {
    ...
    .moves = {MOVE_STOMP, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
};
...
static const struct TrainerMon sParty_Ed_Kendal[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_BATON_PASS, MOVE_ANCIENT_POWER, MOVE_BUG_BITE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
    {
