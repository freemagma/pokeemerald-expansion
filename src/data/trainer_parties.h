// Tutorial O1
static const struct TrainerMon sParty_Tu_Dwayne[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_THUNDER_SHOCK, MOVE_AGILITY, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    }
};

static const struct TrainerMon sParty_Tu_Bruce[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_NIDORAN_M,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCRATCH, MOVE_POISON_STING, MOVE_GROWL, MOVE_NONE},
    .nature = NATURE_BRAVE,
...
// Tutorial O2
static const struct TrainerMon sParty_Tu_Darien[] = {
    {
    .iv = 31,
    .lvl = 10,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENDEAVOR, MOVE_GUST, MOVE_ATTRACT, MOVE_CONFUSION},
    .nature = NATURE_HASTY,
    .ability = ABILITY_SLOT_1,
    },
};

static const struct TrainerMon sParty_Tu_Selina[] = {
    {
    .iv = 31,
    .lvl = 8,
    .species = SPECIES_SUNKERN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_GROWTH, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_QUIET,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_INGRAIN, MOVE_RAZOR_LEAF, MOVE_PIN_MISSILE, MOVE_NONE},
    .nature = NATURE_ADAMANT,
    .ability = ABILITY_SLOT_1,
    },
    {
...
static const struct TrainerMon sParty_Tu_Katrina[] = {
    {
    .iv = 31,
    .lvl = 9,
    .species = SPECIES_CRABRAWLER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUBBLE, MOVE_PURSUIT, MOVE_POWER_UP_PUNCH, MOVE_NONE},
    .nature = NATURE_LAX,
    .ability = ABILITY_SLOT_2,
    },
    {
...
static const struct TrainerMon sParty_Tu_Leah[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DISABLE, MOVE_WILL_O_WISP, MOVE_SHADOW_SNEAK, MOVE_SCRATCH},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_HIDDEN,
    },
};

static const struct TrainerMon sParty_Tu_Freddy[] = {
    {
    .iv = 31,
    .lvl = 8,
    .species = SPECIES_SANDSHREW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_TACKLE, MOVE_POISON_STING, MOVE_NONE},
    ...
    .moves = {MOVE_WATER_GUN, MOVE_CALM_MIND, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_TIMID,
    .ability = ABILITY_SLOT_2,
    },
};
...
static const struct TrainerMon sParty_Tu_Rosemary[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_BODY_SLAM, MOVE_SWALLOW, MOVE_STOCKPILE},
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUD_BOMB, MOVE_BRINE, MOVE_YAWN, MOVE_RECOVER},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
};
...
static const struct TrainerMon sParty_Tu_Everett[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POISON_POWDER, MOVE_SYNTHESIS, MOVE_MAGICAL_LEAF, MOVE_ANCIENT_POWER},
    .nature = NATURE_NAIVE,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULLDOZE, MOVE_ROCK_TOMB, MOVE_WING_ATTACK, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_2,
    },
};
...
// Tutorial Boss
static const struct TrainerMon sParty_Tu_Magnolia[] = {
    {
    .iv = 31,
    .lvl = 8,
    .species = SPECIES_ZWEILOUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HONE_CLAWS, MOVE_DRAGON_TAIL, MOVE_CRUNCH, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_OUT, MOVE_SURF, MOVE_ENERGY_BALL, MOVE_NONE},
    .nature = NATURE_MILD,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_NONE},
...
static const struct TrainerMon sParty_Ed_Edwin[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_TACKLE, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AQUA_TAIL, MOVE_BULLDOZE, MOVE_ROCK_THROW, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_SLOT_1,
    },
};
static const struct TrainerMon sParty_Ed_Fernando[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_TAIL, MOVE_THUNDERBOLT, MOVE_AQUA_TAIL, MOVE_NONE},
    .nature = NATURE_SASSY,
    .ability = ABILITY_SLOT_1,
    },
};
static const struct TrainerMon sParty_Ed_Elise[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLAM, MOVE_RAZOR_LEAF, MOVE_PURSUIT, MOVE_NONE},
    .nature = NATURE_ADAMANT,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_THROW, MOVE_SWIFT, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
};
static const struct TrainerMon sParty_Ed_Francesco[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_CHARGE, MOVE_BODY_PRESS, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_CAREFUL,
    .ability = ABILITY_SLOT_1,
    },
};
...
// Eden A1 O2
static const struct TrainerMon sParty_Ed_Richard[] = {
    {
    .iv = 31,
    .lvl = 9,
    .species = SPECIES_DODUO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_DOUBLE_SLAP, MOVE_NONE, MOVE_PURSUIT},
    .nature = NATURE_LAX,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_HEX, MOVE_BULLDOZE, MOVE_NONE},
    .nature = NATURE_LAX,
    .ability = ABILITY_SLOT_1,
    },
};

static const struct TrainerMon sParty_Ed_Pat[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_GOLBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_FANG, MOVE_GUST, MOVE_ABSORB, MOVE_NONE},
    .nature = NATURE_SASSY,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .moves = {MOVE_ICE_SHARD, MOVE_PURSUIT, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
};

static const struct TrainerMon sParty_Ed_Cory[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_POLIWHIRL,
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_HYPNOSIS, MOVE_WATER_PULSE, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_TIMID,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SHOCK_WAVE, MOVE_SILVER_WIND, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_HIDDEN,
    },
};

static const struct TrainerMon sParty_Ed_Claude[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_ONIX,
    .heldItem = ITEM_SOFT_SAND,
    .moves = {MOVE_STEALTH_ROCK, MOVE_SMACK_DOWN, MOVE_BULLDOZE, MOVE_NONE},
    .nature = NATURE_ADAMANT,
    .ability = ABILITY_SLOT_2
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SEISMIC_TOSS, MOVE_THUNDER_WAVE, MOVE_SOFT_BOILED, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_DEFENSE, MOVE_POISON_STING, MOVE_BUG_BITE, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_HIDDEN,
    },
};

static const struct TrainerMon sParty_Ed_Donna[] = {
    {
    .iv = 31,
    .lvl = 10,
...
// DEdenA1 O3 
static const struct TrainerMon sParty_Ed_Julie[] = {
    {
    .iv = 31,
    .lvl = 9,
    .species = SPECIES_MORELULL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPORE, MOVE_MEGA_DRAIN, MOVE_DRAINING_KISS, MOVE_NONE},
    .nature = NATURE_MODEST,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WILL_O_WISP, MOVE_ANCIENT_POWER, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_QUIET,
    .ability = ABILITY_SLOT_2,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDER_SHOCK, MOVE_SWIFT, MOVE_NONE},
    .nature = NATURE_SASSY,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEX, MOVE_ENERGY_BALL, MOVE_MEAN_LOOK, MOVE_NONE},
    .nature = NATURE_GENTLE,
    .ability = ABILITY_SLOT_1,
    },
};

static const struct TrainerMon sParty_Ed_Ike[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_VULPIX,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_EMBER, MOVE_SUNNY_DAY, MOVE_QUICK_ATTACK, MOVE_NONE},
    .nature = NATURE_RASH,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EMBER, MOVE_SUNNY_DAY, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_MODEST,
    .ability = ABILITY_HIDDEN,
    },
};

static const struct TrainerMon sParty_Ed_Melanie[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_WHISMUR,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_ECHOED_VOICE, MOVE_ASTONISH, MOVE_REST, MOVE_SLEEP_TALK},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_FANG, MOVE_THUNDER_FANG, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_SLOT_1,
    },
};

static const struct TrainerMon sParty_Ed_Herb[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_MAREANIE,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_BRINE, MOVE_BANEFUL_BUNKER, MOVE_SLUDGE, MOVE_NONE},
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_KICK, MOVE_HEADBUTT, MOVE_FLAME_WHEEL, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_HIDDEN,
    },
};

static const struct TrainerMon sParty_Ed_Reginald[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_TYRUNT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_DRAGON_TAIL, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_2,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_DRAGON_DANCE, MOVE_BITE, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_SLOT_1,
    },
    {
...
// Eden A1 Elites
static const struct TrainerMon sParty_Ed_Horatio[] = {
    {
    .iv = 31,
    .lvl = 9,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_CONFUSION, MOVE_ROCK_TOMB, MOVE_NONE},
    .nature = NATURE_SASSY,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_CONFUSION, MOVE_MOONLIGHT, MOVE_NONE},
    .nature = NATURE_HASTY,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KNOCK_OFF, MOVE_SLUDGE_BOMB, MOVE_DIG, MOVE_NONE},
    .nature = NATURE_RELAXED,
    .ability = ABILITY_SLOT_1,
    },
};

static const struct TrainerMon sParty_Ed_Glenda[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_RIOLU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOW_SWEEP, MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_NONE, MOVE_NONE},
    .nature = NATURE_IMPISH,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_PUNCH, MOVE_RAZOR_LEAF, MOVE_DRAINING_KISS, MOVE_NONE},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
    {
...
static const struct TrainerMon sParty_Ed_Kendal[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_YANMEGA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_BATON_PASS, MOVE_ANCIENT_POWER, MOVE_GUST},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SLACK_OFF, MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_NONE},
    .nature = NATURE_HASTY,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .moves = {MOVE_GRASSY_GLIDE, MOVE_FAKE_OUT, MOVE_SLAM, MOVE_KNOCK_OFF},
    .nature = NATURE_ADAMANT,
    .ability = ABILITY_HIDDEN,
    },
};
...
// Eden A1 Boss
static const struct TrainerMon sParty_Ed_Adam1[] = {
    {
    .iv = 31,
    .lvl = 8,
    .species = SPECIES_VILEPLUME,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_ACID, MOVE_MAGICAL_LEAF, MOVE_SYNTHESIS, MOVE_NONE},
    .nature = NATURE_TIMID,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_REVENGE, MOVE_BRUTAL_SWING, MOVE_SLAM, MOVE_AGILITY},
    .nature = NATURE_DOCILE,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_ROCK_TOMB, MOVE_CURSE, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_WATER_PULSE, MOVE_ICY_WIND, MOVE_ATTRACT, MOVE_RAIN_DANCE},
    .nature = NATURE_BOLD,
    .ability = ABILITY_SLOT_1,
    },
};

static const struct TrainerMon sParty_Ed_Adam2[] = {
    {
    .iv = 31,
    .lvl = 8,
    .species = SPECIES_HUNTAIL,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_ICE_FANG, MOVE_FLIP_TURN, MOVE_BITE, MOVE_NONE},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_SLOT_2,
    },
    {
    ...
    .moves = {MOVE_RAZOR_LEAF, MOVE_AERIAL_ACE, MOVE_DIG, MOVE_SUNNY_DAY},
    .nature = NATURE_CAREFUL,
    .ability = ABILITY_HIDDEN,
    },
};
...
// Eden A2 O1
static const struct TrainerMon sParty_Ed_Shane[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_EJECT_BUTTON,
    .moves = {MOVE_ROCK_TOMB, MOVE_DRAIN_PUNCH, MOVE_MACH_PUNCH, MOVE_MEGA_PUNCH},
    .nature = NATURE_ADAMANT,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYBEAM, MOVE_FAIRY_WIND, MOVE_KINESIS, MOVE_ENERGY_BALL},
    .nature = NATURE_CALM,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FIRE_FANG, MOVE_SLUDGE_BOMB, MOVE_CRUNCH, MOVE_GLARE},
    .nature = NATURE_DOCILE,
    .ability = ABILITY_SLOT_1,
    },
};
static const struct TrainerMon sParty_Ed_Florence[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_IVYSAUR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_LEECH_SEED, MOVE_SYNTHESIS},
    .nature = NATURE_MODEST,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULLDOZE, MOVE_BITE, MOVE_FOUL_PLAY, MOVE_THRASH},
    .nature = NATURE_JOLLY,
    .ability = ABILITY_SLOT_2,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYBEAM, MOVE_MEGA_KICK, MOVE_HYPNOSIS, MOVE_NONE},
    .nature = NATURE_HARDY,
    .ability = ABILITY_HIDDEN,
    },
    {
    ...
    .moves = {MOVE_DRILL_PECK, MOVE_DRILL_RUN, MOVE_LUNGE, MOVE_QUICK_ATTACK},
    .nature = NATURE_HASTY,
    .ability = ABILITY_SLOT_2,
    },
};
static const struct TrainerMon sParty_Ed_Teddy[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_MIENFOO,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_FAKE_OUT, MOVE_KNOCK_OFF, MOVE_FORCE_PALM, MOVE_U_TURN},
    .nature = NATURE_QUIRKY,
    .ability = ABILITY_SLOT_2,
    },
    {
    ...
    .moves = {MOVE_THUNDER_SHOCK, MOVE_MAGNET_BOMB, MOVE_THUNDER_WAVE, MOVE_NONE},
    .nature = NATURE_TIMID,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BITE, MOVE_FLAMETHROWER, MOVE_MORNING_SUN, MOVE_DOUBLE_KICK},
    .nature = NATURE_SERIOUS,
    .ability = ABILITY_SLOT_1,
    },
};
static const struct TrainerMon sParty_Ed_Sam[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_PONYTA_GALARIAN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CONFUSION, MOVE_DAZZLING_GLEAM, MOVE_STOMP, MOVE_NONE},
    .nature = NATURE_TIMID,
    .ability = ABILITY_SLOT_2,
    },
    {
...
static const struct TrainerMon sParty_Ed_Pierce[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_RUNERIGUS,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_AMNESIA, MOVE_SHADOW_CLAW, MOVE_SAND_TOMB, MOVE_NONE},
    .nature = NATURE_IMPISH,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_AIR_CUTTER, MOVE_MUD_SHOT, MOVE_STRUGGLE_BUG},
    .nature = NATURE_RELAXED,
    .ability = ABILITY_SLOT_1,
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAZOR_LEAF, MOVE_BITE, MOVE_BULLDOZE, MOVE_BODY_SLAM},
    .nature = NATURE_IMPISH,
    .ability = ABILITY_HIDDEN,
    },
};
...
// Eden A2 O2
static const struct TrainerMon sParty_Ed_Summer[] = {
    {
    .iv = 31,
    .lvl = 10,
...
static const struct TrainerMon sParty_Ed_Luke[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Yasmin[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Arthur[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Paige[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
// Eden A2 O3
static const struct TrainerMon sParty_Ed_Kevin[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Rae[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Gavin[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Camille[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Neil[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
// Eden A2 Elites
static const struct TrainerMon sParty_Ed_Valencia[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Maximilian[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Barnabus[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
// Eden A2 Boss
static const struct TrainerMon sParty_Ed_Eve1[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMon sParty_Ed_Eve2[] = {
    {
    .iv = 31,
    .lvl = 10,
    .species = SPECIES_EEVEE,
