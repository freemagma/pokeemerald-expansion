...
#define AI_FLAGS_BASE (AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY)
#define AI_FLAGS_STRONG (AI_FLAGS_BASE | AI_FLAG_SETUP_FIRST_TURN | AI_FLAG_SMART_SWITCHING | AI_FLAG_PREFER_STRONGEST_MOVE | AI_FLAG_HP_AWARE)
#define AI_FLAGS_RISKY (AI_FLAGS_STRONG | AI_FLAG_RISKY)
